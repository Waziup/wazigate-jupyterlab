...
jupyter lab --ServerApp.port='9000' --ServerApp.allow_root='true' --ServerApp.token='' --ServerApp.password='' --ServerApp.allow_origin='*' --ServerApp.ip='0.0.0.0' --notebook-dir='workspace/'